export default function AboutPreview() {
    return (
      <section id="about" className="py-16 bg-[#1E1E1E] text-[#E0E0E0] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <a href="/about" className="inline-block mt-6 text-[#E67E22] text-lg font-medium hover:underline">
            Read More →
          </a>
        </div>
      </section>
